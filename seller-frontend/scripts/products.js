window.onload = () => {
  ...
  function displaybyCategroy(categorySelected) {
    let payload = { search: "0", category: categorySelected };
    let config = {
      headers: { Authorization: localStorage.jwt },
    };
    let res = axios
      .post(
        "http://localhost/E-Commerce.HippoWare/ecommerce-server/seller/products.php",
        payload,
        config
      )
  ...
  function deleteProduct(id) {
    deleteItem.onclick = () => {
      ...
      axios
        .post(
          "http://localhost/E-Commerce.HippoWare/ecommerce-server/seller/delete-product.php",
          payload,
          config
        )
        .then(function (response) {
  ...
  async function uplaodNewPorduct() {
    ...
    let res = axios
      .post(
        "http://localhost/E-Commerce.HippoWare/ecommerce-server/seller/add-product.php",
        payload,
        config
      )
      .then(function (response) {
  ...
  res = axios
    .post(
      "http://localhost/E-Commerce.HippoWare/ecommerce-server/seller/categories.php",
      payload,
      config
    )
    .then(function (response) {
  ...
  dropDownContents.onclick = (e) => {
    ...
    if (categoryArray.includes(clickedCategory)) {
      ...
      let res = axios
        .post(
          "http://localhost/E-Commerce.HippoWare/ecommerce-server/seller/add-category.php",
          payload,
          config
        )
        .then(function (response) {
  ...
  function searchforProduct(productName) {
    let payload = { search: productName, category: "0" };
    let config = {
      headers: { Authorization: localStorage.jwt },
    };
    let res = axios
  ...
  function registeraStore() {
    ...
    let res = axios
      .post(
        "http://localhost/E-Commerce.HippoWare/ecommerce-server/seller/add-store.php",
        payload,
        config
      )
      .then(function (response) {
